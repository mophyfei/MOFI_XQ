...
本腳本為**自訂 XScript 指標**，且會在圖上**繪製財務資訊（本益比）**，需訂閱：

| 模組 | 解鎖 | 本腳本 |
|------|------|:---:|
| **盤中量化交易模組**<br><sub>$1,000/月</sub> | 自訂指標／XScript、警示、回溯 | ✅ 必要 |
| **盤後量化選股模組**<br><sub>$1,000/月</sub> | 財務／基本面／籌碼面等 900 資料欄位（含**本益比**） | ✅ 必要（繪製財務資訊需要） |

> 💡 自訂指標需「盤中量化交易模組」；要在圖上**繪製財務資訊（如本益比）須再加「盤後量化選股模組」**。手機僅限監控訊號，完整功能需電腦版。[XQ 模組比較](https://www.xq.com.tw/module-compare/)。
